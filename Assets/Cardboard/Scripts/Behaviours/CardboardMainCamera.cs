...
namespace MobfishCardboard
{
    public class CardboardMainCamera: MonoBehaviour
    {
        ...
        //Following written by Nicholas Jennings
        public void ChangePoV(Matrix4x4 leftMat, Matrix4x4 rightMat)
        {
            RefreshCamera_Eye(leftCam,
                leftMat, CardboardManager.eyeFromHeadMatrixLeft);
            RefreshCamera_Eye(rightCam,
                rightMat, CardboardManager.eyeFromHeadMatrixRight);
        }

        public void getPov(out Matrix4x4 lmat, out Matrix4x4 rmat)
        {
            lmat = leftCam.projectionMatrix;
            rmat = rightCam.projectionMatrix;
        }
